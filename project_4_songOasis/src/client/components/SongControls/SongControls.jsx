...
class SongControls extends React.Component {
  ...
  nextSong() {
    ...
    if (this.props.song) {
      ...
      currentIndex === this.props.songs.length - 1 ? this.audioControl(this.props.songs[0]) : this.audioControl(this.props.songs[currentIndex + 1]);
    }
  ...
  prevSong() {
    ...
    if (this.props.song) {
      //const { songs, audioControl } = this.props;
      let currentIndex = this.getSongIndex();
      currentIndex === 0 ? this.audioControl(this.props.songs[this.props.songs.length - 1]) : this.audioControl(this.props.songs[currentIndex - 1]);
    }
  }

  render() {

    console.log("this.props.songPaused :: " + this.props.songPaused)
